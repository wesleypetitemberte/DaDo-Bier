<section class="portfolio">
    ...
    <div class='name-header'>
        ...
        <h1>CERVEJAS</h1>
        <span>A Drink Beer É A PRIMEIRA CERVEJARIA<br>BRASILEIRA A SEGUIR O <b>REINHEITSGEBOT*</b></br></span>
        <p>*Decreto de Pureza da Baviera, criado em 1516 para<br>disciplinar a produção cervejeira na Alemanha.</p>
    </div>

    <div class="block-search-beer">
        <h2>CONHEÇA NOSSAS BEBIDAS</h2>

        <div class="form-container">
            <select name="Cervejas">
                <option value="" selected>Cervejas</option>
                <option value="1">Craft American Lager</option>
                <option value="2">Duons</option>
        ...
        <div class="form-container">
            <select name="Outras Bebidas">
                <option value="" selected>Outras Bebidas</option>
                <option value="1">Ilex</option>
